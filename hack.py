...
def idgroup():
	...
	i = inputD('[?]Langsung Hack (y/t)',['Y','T'])
...
def crack(d):
	...
	if i.upper() == 'P':
		...
		tampil('\rh[*]Memulai hack dengan \rk%d password'%len(D))
...
def crack0(data,sandi,p):
	...
	tampil('\rh[*]MengHack \rk%d Akun \rhdengan sandi \rm[\rk%s\rm]'%(len(data),sandi))

	print('\033[32;1m[*]Hacking \033[31;1m[\033[36;1m0%\033[31;1m]\033[0m',end='')
	...
	print('\r\033[32;1m[*]Hacking \033[31;1m[\033[36;1m100%\033[31;1m]\033[0m ')
...
# \rb*HACK AKUN FACEBOOK*\rk #

# \rhBY\rp PIRMANSX \rk#

# \rhGroup FB\rp https://m.facebook.com/groups/246682935936786\rk#

# \rhGitHub\rp https://github.com/mrbytee \rk#
